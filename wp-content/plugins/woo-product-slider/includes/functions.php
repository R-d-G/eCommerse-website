...
class SP_Woo_Product_Slider_Functions {
	...
	function pro_admin_notice() {
		if (class_exists('SP_WooCommerce_Product_Slider_PRO')) {
			...
			<div class="notice notice-error is-dismissible">
				<p><b>WooCommerce Product Slider</b> free version is active. Please, deactivate the free version to get better performance of the pro version.</p>
			</div>
			<?php
		}
	}
	 ...
	 */
	function admin_menu() {
		add_submenu_page('edit.php?post_type=sp_wps_shortcodes', __('WooCommerce Product Slider Help', 'woo-product-slider'), __('Help', 'woo-product-slider' ), 'manage_options', 'wps_help', array( $this, 'help_page_callback'));
	}
	...
	public function help_page_callback() {
		...
		<div class="wrap about-wrap sp-wps-help">
			<h1><?php _e('Welcome to WooCommerce Product Slider!', 'woo-product-slider'); ?></h1>
			<p class="about-text"><?php _e('Thank you for installing WooCommerce Product Slider! You\'re now running the most popular WooCommerce Product Slider plugin. This video will help you get started with the plugin.', 'woo-product-slider'); ?></p>
			...
			<div class="feature-section three-col">
				...
				<div class="col">
					<div class="sp-wps-feature sp-wps-text-center">
						...
						<p>We have detailed documentation on every aspects of WooCommerce Product Slider.</p>
			...
			<div class="sp-wps-pro-features">
				<h2 class="sp-wps-text-center">Upgrade to WooCommerce Product Slider Pro!</h2>
				...
				<div class="feature-section three-col">
					...
					<div class="col">
						<div class="sp-wps-feature">
							...
							<p>This is another cool feature of WooCommerce Product Slider Pro. This feature will allow you to show excluding specific product categories on the slider.
					...
					<div class="col">
						<div class="sp-wps-feature">
							...
							<p>This is an another amazing feature of WooCommerce Product Slider Pro. It slides with infinite loop, with no Pause. You can set the speed and if the slider pauses on hover. You can enable or disable this option easily from the beginning of slider settings.</p>
						</div>
					</div>
					<div class="col">
						<div class="sp-wps-feature">
					...
					<div class="col">
						<div class="sp-wps-feature">
							...
							<p>WooCommerce Product Slider Pro has three amazing features like Quick-View, Wishlist, & Compare Options. These three important features can help you attract your product and increase sales. And it is only possible with Pro version.</p>
						</div>
					</div>
					<div class="col">
						<div class="sp-wps-feature">
					...
					<div class="col">
						<div class="sp-wps-feature">
							...
							<p>This is another amazing feature of WooCommerce Product Slider Pro. It slides smoothly with the infinite loop, with no Pause. You can set the speed and if the slider pauses on hover. You can enable or disable this option easily from the beginning of slider settings.</p>
						</div>
					</div>
					<div class="col">
						<div class="sp-wps-feature">
							<h3><span class="dashicons dashicons-yes"></span>Slider Settings</h3>
							<p>In the slider settings of the WooCommerce Product Slider Pro plugin, you can set how many products to scroll at a time in the slider or show, the transition speed, autoplay, swipe, pause on hover, infinite loop, mouse draggable, ticker mode, and many other settings.</p>
						</div>
					</div>
					<div class="col">
						<div class="sp-wps-feature">
	...
	public function admin_footer( $text ) {
		if ( 'sp_wps_shortcodes' == get_post_type() ) {
			...
			$text = sprintf( __( 'If you like <strong>WooCommerce Product Slider</strong> please leave us a <a href="%s" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. Your Review is very important to us as it helps us to grow more. ', 'woo-product-slider' ), $url );
		}
